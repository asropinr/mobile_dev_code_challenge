...
class PesanGambarByName extends StatefulWidget {
  final List items;
  final String rules;
  PesanGambarByName({
    Key key,
  ...
  @override
  _PesanGambarByNameState createState() => _PesanGambarByNameState();
}

class _PesanGambarByNameState extends State<PesanGambarByName> {
  @override
